...
import static main.java.httpCore.HttpMethodType.DELETE;
import static main.java.httpCore.MimeType.APPLICATION_JSON;

public class DeleteApi extends BaseRestService {
    /**
     ...
     */
    public DeleteApi(int bookingId) {
        super(String.format("%s/%d", PropertyUtil.getPropertyValue("booking.api.endpoint"), bookingId), APPLICATION_JSON, DELETE);
    }
}
